...
#' or tab-delimited .txt file.
#' @param ionmode Ionization mode for distinguishing alignment IDs in
#' the curated feature list. The input feature list should have a column
#' named "Mode."
...
#' @return A list object containing a data matrix with the final feature and
#' sample metadata for the specified ionization mode.
#' @examples
#'
...
ms_postproc <- function(
  ...
  d3 <- list(
    ...
    "data" = magrittr::set_rownames(d2filt, d2filt[[c1]])[-1],
    # feature metadata
    "anno" = d2filt2,
    # sample metadata
